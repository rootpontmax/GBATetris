...
////////////////////////////////////////////////////////////////////////////////////////////////////
volatile SSpriteAttr           *g_spriteAttribs = &MEM_OAM[0];
...
{
    g_spriteAttribs->attr0 = BLOCK_ATTR0;
    g_spriteAttribs->attr1 = BLOCK_ATTR1;
    g_spriteAttribs->attr2 = 2;
}
////////////////////////////////////////////////////////////////////////////////////////////////////
void InitGraphics()
{
...
void ShowBlock(const int id, const int x, const int y )
{
    ...
    const int posX = 80 + ( x << 3 );
    const int posY = y << 3;
    const uint16_t attr0 = (uint16_t)( posY & POS_MASK );
    const uint16_t attr1 = (uint16_t)( posX & POS_MASK );
    g_spriteAttribs->attr0 = BLOCK_ATTR0 | attr0;
    g_spriteAttribs->attr1 = BLOCK_ATTR1 | attr1;
}
////////////////////////////////////////////////////////////////////////////////////////////////////